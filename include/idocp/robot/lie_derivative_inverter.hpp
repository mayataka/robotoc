#ifndef IDOCP_LIE_DERIVATIVE_INVERTER_HPP_
#define IDOCP_LIE_DERIVATIVE_INVERTER_HPP_
...
#include "idocp/robot/lie_derivative_inverter.hxx"

#endif // IDOCP_LIE_DERIVATIVE_INVERTER_HPP_