#ifndef IDOCP_OCP_RICCATI_SOLVER_HXX_
#define IDOCP_OCP_RICCATI_SOLVER_HXX_

#include "idocp/ocp/ocp_riccati_solver.hpp"

namespace idocp {

inline OCPRiccatiSolver::OCPRiccatiSolver(const Robot& robot, const double T, 
                                          const int N, 
...
inline OCPRiccatiSolver::OCPRiccatiSolver() 
  : riccati_recursion_(),
...
inline void OCPRiccatiSolver::computeDirection(
...
#endif // IDOCP_OCP_RICCATI_SOLVER_HXX_ 