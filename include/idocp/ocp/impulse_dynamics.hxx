...
inline void LinearizeImpulseDynamics(Robot& robot, 
...
inline void ImpulseDynamics::condenseImpulseDynamics(
  ...
  if (has_floating_base_) {
    ...
    // and squaredNormImpulseDynamicsResidual.
...
inline void ImpulseDynamics::linearizeInverseDynamics(
...
inline void ImpulseDynamics::linearizeContactConstraint(
    Robot& robot, const ContactStatus& contact_status, const double dtau, 
...
inline void ImpulseDynamics::setContactForces(Robot& robot, 
                                            const ContactStatus& contact_status, 
                                            const SplitSolution& s) {
...
inline void ImpulseDynamics::computeInverseDynamicsResidual(
...
inline void ImpulseDynamics::computeFloatingBaseConstraintResidual(
...
inline void ImpulseDynamics::computeContactConstraintResidual(
...
inline void ImpulseDynamics::getStateFeedbackGain(
