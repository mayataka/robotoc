...
public:
  ...
  ///
  double costSlackBarrier(const ConstraintsData& data, const double dtau) const;
  ...
  /// @return Value of the barrier function. 
  ///
  double costSlackBarrier(const ConstraintsData& data, const double dtau,
  ...
  ///
  double l1NormPrimalResidual(const ConstraintsData& data, 
  ...
  ///
  double squaredNormPrimalAndDualResidual(const ConstraintsData& data,
                                          const double dtau) const;
