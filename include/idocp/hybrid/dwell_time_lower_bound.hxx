#ifndef IDOCP_DWELL_TIME_LOWER_BOUND_HXX_
#define IDOCP_DWELL_TIME_LOWER_BOUND_HXX_
...
inline DwellTimeLowerBound::DwellTimeLowerBound(
  ...
  : barrier_(barrier),
    ...
    slack_(std::sqrt(barrier)), 
    dual_(std::sqrt(barrier)), 
    residual_(0), 
    cmpl_(0), 
    dslack_(0), 
    ddual_(0), 
...
#endif // IDOCP_DWELL_TIME_LOWER_BOUND_HXX_ 