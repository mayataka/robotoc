#ifndef IDOCP_JOINT_SPACE_BARRIER_HPP_
#define IDOCP_JOINT_SPACE_BARRIER_HPP_
...
class JointSpaceBarrier {
public:
  JointSpaceBarrier(const Robot& robot, const Eigen::VectorXd& q_weight,  
  ...
  JointSpaceBarrier(const Robot& robot, const Eigen::VectorXd& q_ref, 
  ...
  JointSpaceBarrier(const JointSpaceCost&) = delete;

  // Prohibits copy operator.
  JointSpaceBarrier& operator=(const JointSpaceCost&) = delete;
...
#endif // IDOCP_JOINT_SPACE_BARRIER_HPP_