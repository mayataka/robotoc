#ifndef ROBOTOC_RAIBERT_TROTTING_FOOT_STEP_PLANNER_HPP_
#define ROBOTOC_RAIBERT_TROTTING_FOOT_STEP_PLANNER_HPP_
...
///
/// @class RaibertTrottingFootStepPlanner
/// @brief Foot step planner for the trotting gait of quadrupeds. 
///
class RaibertTrottingFootStepPlanner final : public FootStepPlannerBase {
public:
  ///
  /// @brief Constructs the planner.
  /// @param[in] quadruped_robot Quadruped robot model. 
  ///
  RaibertTrottingFootStepPlanner(const Robot& quadruped_robot);

  ///
  /// @brief Default constructor. 
  ///
  RaibertTrottingFootStepPlanner();
  ...
  ///
  RaibertTrottingFootStepPlanner(const RaibertTrottingFootStepPlanner&) = default;

  ///
  /// @brief Default copy assign operator. 
  ///
  RaibertTrottingFootStepPlanner& operator=(const RaibertTrottingFootStepPlanner&) = default;

  ///
  /// @brief Default move constructor. 
  ///
  RaibertTrottingFootStepPlanner(RaibertTrottingFootStepPlanner&&) noexcept = default;

  ///
  /// @brief Default move assign operator. 
  ///
  RaibertTrottingFootStepPlanner& operator=(RaibertTrottingFootStepPlanner&&) noexcept = default;
  ...
  ///
  /// @brief This is invalid in RaibertTrottingFootStepPlanner. 
  ///
...
#endif // ROBOTOC_RAIBERT_TROTTING_FOOT_STEP_PLANNER_HPP_