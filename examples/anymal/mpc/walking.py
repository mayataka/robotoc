...
com_ref = robotoc.PeriodicCoMRef2(com_ref0, v_com_ref, t0, 2*swing_time, 0., True)
...
nthreads = 4
mpc = robotoc.MPCQuadrupedalWalking(robot, cost, constraints, T, N, 
                                    max_steps, nthreads)
...
# sim.run_simulation(mpc, q, v, num_mpc_iteration=2, verbose=False, record=True, record_name='anymal_walking.mp4')