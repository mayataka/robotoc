...
com_ref = robotoc.PeriodicCoMRef(com_ref0, v_com_ref, t0, 2*period_swing, 
...
contact_sequence.push_back(contact_status_lh, 
...
contact_sequence.push_back(contact_status_lf, 
