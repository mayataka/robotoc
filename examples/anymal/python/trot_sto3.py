...
dv_weight_impulse  = np.full(robot.dimv(), 1.0e-03)
config_cost = robotoc.ConfigurationSpaceCost(robot)
config_cost.set_q_ref(q_ref)
config_cost.set_v_ref(v_ref)
config_cost.set_q_weight(q_weight)
config_cost.set_q_weight_terminal(q_weight)
config_cost.set_q_weight_impulse(q_weight)
...
LF_cost.set_weight(swing_foot_ref_weight)
LH_cost.set_weight(swing_foot_ref_weight)
RF_cost.set_weight(swing_foot_ref_weight)
RH_cost.set_weight(swing_foot_ref_weight)
