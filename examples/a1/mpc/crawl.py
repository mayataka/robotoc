...
sim.run_simulation(mpc, q, v, feedback_delay=True, verbose=False, 
                   record=record, log=log, sim_name='a1_crawl')

if record:
    robotoc.utils.adjust_video_duration('a1_crawl.mp4', 
...
if log:
    ...
    plot_mpc.plot(t_log, v_com_log, w_com_log, fig_name='a1_crawl_com_vel')
