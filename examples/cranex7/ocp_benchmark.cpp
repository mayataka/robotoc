...
void BenchmarkWithoutContacts() {
  ...
  const Eigen::VectorXd q_ref = Eigen::VectorXd::Constant(robot.dimv(), 1);
  ...
  idocp::OCPBenchmarker<idocp::OCP> ocp_benchmarker("OCP for crane-x7 without contacts",
  ...
  idocp::OCPBenchmarker<idocp::ParNMPC> parnmpc_benchmarker("ParNMPC for crane-x7 without contacts",
                                                            robot, cost, constraints, T, N, num_proc);
  parnmpc_benchmarker.setInitialGuessSolution(t, q, v);
  parnmpc_benchmarker.testConvergence(t, q, v, 50, false);
...
void BenchmarkWithContacts() {
  ...
  idocp::OCPBenchmarker<idocp::OCP> ocp_benchmarker("OCP for crane-x7 with contacts",
                                                    robot, cost, constraints, T, N, num_proc);
  ocp_benchmarker.setInitialGuessSolution(t, q, v);
  ...
  idocp::OCPBenchmarker<idocp::ParNMPC> parnmpc_benchmarker("ParNMPC for crane-x7 with contacts",
                                                            robot, cost, constraints, T, N, num_proc);
  parnmpc_benchmarker.setInitialGuessSolution(t, q, v);
