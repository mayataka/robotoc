...
TEST_F(ImpulseSplitSolutionTest, fixed_base) {
  ...
  EXPECT_EQ(s.dimf(), 0);
  EXPECT_EQ(s.dimc(), 0);
  ImpulseSplitSolution s_random = ImpulseSplitSolution::Random(robot);
...
TEST_F(ImpulseSplitSolutionTest, floating_base) {
