...
TEST_F(ImpulseSplitDirectionTest, fixed_base_contact) {
  ...
  EXPECT_EQ(d.max_dimKKT(), 4*robot.dimv()+3*3);
  ...
  EXPECT_EQ(d.dmu_contact_position().size(), 0);
  EXPECT_EQ(d.dmu_contact_velocity().size(), 0);
  ...
  EXPECT_EQ(d.dimf(), 3);
  EXPECT_EQ(d.dimc(), 2*3);
  EXPECT_EQ(d.dimKKT(), 4*robot.dimv()+3*3);
  EXPECT_EQ(d.max_dimKKT(), 4*robot.dimv()+3*3);
  EXPECT_EQ(d.split_direction().size(), d.dimKKT());
  EXPECT_EQ(d.dlmd().size(), robot.dimv());
  EXPECT_EQ(d.dgmm().size(), robot.dimv());
  EXPECT_EQ(d.dmu().size(), d.dimc());
  EXPECT_EQ(d.dmu_contact_position().size(), d.dimf());
  EXPECT_EQ(d.dmu_contact_velocity().size(), d.dimf());
  ...
  EXPECT_TRUE(dmu_position.isApprox(d.dmu_contact_position()));
  EXPECT_TRUE(dmu_velocity.isApprox(d.dmu_contact_velocity()));
  ...
  EXPECT_TRUE(d.dmu_contact_position().isZero());
  EXPECT_TRUE(d.dmu_contact_velocity().isZero());
  ...
  EXPECT_EQ(d_random.dimc(), 2*3);
  EXPECT_EQ(d_random.dimKKT(), 4*robot.dimv()+3*3);
  EXPECT_EQ(d_random.max_dimKKT(), 4*robot.dimv()+3*3);
  ...
  EXPECT_EQ(d_random.dmu_contact_position().size(), d.dimf());
  EXPECT_EQ(d_random.dmu_contact_velocity().size(), d.dimf());
...
TEST_F(ImpulseSplitDirectionTest, floating_base_full_contacts) {
  ...
  EXPECT_EQ(d.dimc(), 0);
  EXPECT_EQ(d.dimKKT(), 4*robot.dimv());
  EXPECT_EQ(d.max_dimKKT(), 4*robot.dimv()+4*3+2*4*3);
  EXPECT_EQ(d.split_direction().size(), d.dimKKT());
  EXPECT_EQ(d.dlmd().size(), robot.dimv());
  EXPECT_EQ(d.dgmm().size(), robot.dimv());
  EXPECT_EQ(d.dmu().size(), 0);
  ...
  EXPECT_EQ(d.dimc(), 2*4*3);
  EXPECT_EQ(d.dimKKT(), 4*robot.dimv()+4*3+2*4*3);
  EXPECT_EQ(d.max_dimKKT(), 4*robot.dimv()+4*3+2*4*3);
  EXPECT_EQ(d.split_direction().size(), d.dimKKT());
  EXPECT_EQ(d.dlmd().size(), robot.dimv());
  EXPECT_EQ(d.dgmm().size(), robot.dimv());
...
TEST_F(ImpulseSplitDirectionTest, floating_base) {
  ...
  EXPECT_EQ(d.dimc(), 2*contact_status.dimf());
  EXPECT_EQ(d.dimKKT(), 4*robot.dimv()+3*contact_status.dimf());
  EXPECT_EQ(d.max_dimKKT(), 4*robot.dimv()+4*3+2*4*3);
  EXPECT_EQ(d.split_direction().size(), d.dimKKT());
  EXPECT_EQ(d.dlmd().size(), robot.dimv());
  EXPECT_EQ(d.dgmm().size(), robot.dimv());
