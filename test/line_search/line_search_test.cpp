...
Solution LineSearchTest::createSolution(const Robot& robot, const ContactSequence& contact_sequence) const {
...
Direction LineSearchTest::createDirection(const Robot& robot, const ContactSequence& contact_sequence) const {
