...
class FloatingBaseOCPLinearizerTest : public ::testing::Test {
protected:
  virtual void SetUp() {
...
TEST_F(FloatingBaseOCPLinearizerTest, linearizeStageCost) {
...
TEST_F(FloatingBaseOCPLinearizerTest, linearizeDynamics) {
...
TEST_F(FloatingBaseOCPLinearizerTest, linearizeConstraints) {
