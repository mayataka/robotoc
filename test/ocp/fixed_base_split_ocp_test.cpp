...
TEST_F(FixedBaseSplitOCPTest, KKTErrorNormEmptyCost) {
  ...
  robotdynamics.linearizeRobotDynamics(robot, contact_status, dtau, s, kkt_matrix, kkt_residual);
  ...
  kkt_error_ref += robotdynamics.squaredNormRobotDynamicsResidual(dtau, kkt_residual);
