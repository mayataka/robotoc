...
TEST_F(KKTMatrixTest, fixed_base) {
  ...
  EXPECT_EQ(matrix.Quu_passive_topLeft().cols(), 0);
  EXPECT_EQ(matrix.Quu_passive_topRight().rows(), 0);
  EXPECT_EQ(matrix.Quu_passive_topRight().cols(), dimu);
  EXPECT_EQ(matrix.Quu_passive_bottomLeft().rows(), dimu);
  EXPECT_EQ(matrix.Quu_passive_bottomLeft().cols(), 0);
  ...
  EXPECT_TRUE(matrix.Quu_passive_topRight().isZero());
  EXPECT_TRUE(matrix.Quu_passive_bottomLeft().isZero());
...
TEST_F(KKTMatrixTest, floating_base) {
  ...
  EXPECT_EQ(matrix.Quu_passive_topLeft().cols(), 6);
  EXPECT_EQ(matrix.Quu_passive_topRight().rows(), 6);
  EXPECT_EQ(matrix.Quu_passive_topRight().cols(), dimu);
  EXPECT_EQ(matrix.Quu_passive_bottomLeft().rows(), dimu);
  EXPECT_EQ(matrix.Quu_passive_bottomLeft().cols(), 6);
  EXPECT_EQ(matrix.Quu().rows(), dimu);
  EXPECT_EQ(matrix.Quu().cols(), dimu);
  EXPECT_EQ(matrix.Quq_full().rows(), dimv);
  EXPECT_EQ(matrix.Quq_full().cols(), dimv);
  ...
  EXPECT_TRUE(matrix.Quu_passive_topRight().isApprox(Quu_full.topRightCorner(6, dimu)));
  EXPECT_TRUE(matrix.Quu_passive_bottomLeft().isApprox(Quu_full.bottomLeftCorner(dimu, 6)));
  EXPECT_TRUE(matrix.Quq_full().isApprox(Quq_full));
  ...
  EXPECT_TRUE(matrix.Qxu_passive().isApprox(matrix.Qxu_full().leftCols(6)));
  ...
  EXPECT_TRUE(matrix.Qux_passive().isApprox(matrix.Qux_full().topRows(6)));
