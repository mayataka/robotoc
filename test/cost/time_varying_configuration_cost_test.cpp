...
class TimeVaryingConfigurationCostTest : public ::testing::Test {
protected:
  virtual void SetUp() {
...
void TimeVaryingConfigurationCostTest::test(Robot& robot) const {
...
TEST_F(TimeVaryingConfigurationCostTest, fixedBase) {
  Robot robot(fixed_base_urdf);
  test(robot);
}


TEST_F(TimeVaryingConfigurationCostTest, floatingBase) {
