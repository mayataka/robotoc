...
WrenchFrictionCone::WrenchFrictionCone(const Robot& robot, const double X, 
                                       const double Y)
...
void WrenchFrictionCone::computeCone(const double mu, 
...
void WrenchFrictionCone::updateCone(const double mu, 
                                    Eigen::MatrixXd& cone) const {
  for (int i=1; i<5; ++i) {
