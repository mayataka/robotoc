...
OCPSolutionIntegrator::OCPSolutionIntegrator(const double T, const int N, 
...
OCPSolutionIntegrator::OCPSolutionIntegrator()
  : T_(0),
    dtau_(0),
    N_(0),
    num_proc_(0) {
...
void OCPSolutionIntegrator::integrate(
    HybridOCP& split_ocps, const std::vector<Robot>& robots, 
