...
CrawlFootStepPlanner::CrawlFootStepPlanner(const Robot& quadruped_robot)
  : ContactPlannerBase(),
...
CrawlFootStepPlanner::CrawlFootStepPlanner() {
}
...
void CrawlFootStepPlanner::setGaitPattern(const Eigen::Vector3d& step_length, 
